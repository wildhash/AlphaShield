...
def main():
    ...
    print("  │   └─ Invests algorithmically to generate returns")
    ...
    print("        making the 8% rate even more affordable!")
    ...
    print("   • Receive ongoing AI financial guidance")
    print("   • Avoid debt trap and build wealth instead")

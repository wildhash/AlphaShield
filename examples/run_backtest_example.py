...
def main():
    if os.path.exists("config/trading.yaml"):
        with open("config/trading.yaml") as _f:
    ...
    res = bt.run(
        prices,
        cfg["backtesting"]["loan_params"],
        cfg["backtesting"]["rebalance_freq"],
        cfg["backtesting"]["initial_capital"],
    )

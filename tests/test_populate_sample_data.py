...
class TestPopulateSampleData(unittest.TestCase):
    ...
    def test_populate_sample_data_structure(self, mock_mongo_class):
        ...
        collection_map = {
            "brokerage_statements": mock_brokerage_collection,
            "credit_card_statements": mock_credit_card_collection,
            "credit_reports": mock_credit_report_collection,
        }
        mock_client.get_collection.side_effect = collection_map.get

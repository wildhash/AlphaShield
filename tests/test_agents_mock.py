...
class TestLenderAgent(unittest.TestCase):
    ...
    def test_originate_loan(self):
        ...
        loan_id = self.agent.originate_loan(
            borrower_id="borrower_456", principal=10000, interest_rate=8.0, term_months=36
        )
...
class TestTaxOptimizerAgent(unittest.TestCase):
    ...
    def test_tax_calculation(self):
        ...
        result = self.agent.analyze_tax_situation("borrower_123", income, deductions, "single")

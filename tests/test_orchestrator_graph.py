...
from alphashield.orchestrator.graph import OriginationBundle, StorageClient, execute
...
class TestOriginationBundle(unittest.TestCase):
    ...
    def test_bundle_creation(self):
        ...
        bundle = OriginationBundle(trace_id="trace_1", loan_app_id="loan_456", user_id="user_123")
...
class TestOrchestratorExecution(unittest.TestCase):
    ...
    def test_execute_without_db(self):
        ...
        bundle = execute(trace_id="trace_1", user_id="user_123", loan_app_id="loan_456")
    ...
    def test_execute_with_short_term_relief(self):
        ...
        bundle = execute(
            trace_id="trace_2", user_id="user_123", loan_app_id="loan_456", short_term_relief=True
        )
    ...
    def test_execute_with_low_credit_score(self):
        ...
        bundle = execute(
            trace_id="trace_3", user_id="user_123", loan_app_id="loan_456", db_client=mock_db
        )
    ...
    def test_audit_trail_contains_hashes(self):
        ...
        bundle = execute(trace_id="trace_4", user_id="user_123", loan_app_id="loan_456")

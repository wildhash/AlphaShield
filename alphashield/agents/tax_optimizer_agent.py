...
class TaxOptimizerAgent(BaseAgent):
    ...
    def analyze_tax_situation(
        ...
        standard_deduction = {"single": 13850, "married": 27700, "head_of_household": 20800}
    ...
    def process(self, loan_id: str, **kwargs) -> dict[str, Any]:
        ...
        loan_interest = (
            loan_data.get("interest_rate", 0) * loan_data.get("outstanding_balance", 0) / 100
        )
        if loan_interest > 0:
    ...
    def generate_tax_strategy(self, borrower_id: str, loan_id: str) -> dict[str, Any]:
        ...
        contexts = self.get_shared_context(
            agent_name=self.name, context_type="tax_analysis", limit=3
        )
